export const MACHINE_CATEGORIES = [
    { key: "peito", label: "Peito", labelKey: "categories.peito", color: "#E24B4A" },
    { key: "costas", label: "Costas", labelKey: "categories.costas", color: "#378ADD" },
    { key: "pernas", label: "Pernas", labelKey: "categories.pernas", color: "#639922" },
    { key: "ombros", label: "Ombros", labelKey: "categories.ombros", color: "#F4A261" },
    { key: "biceps", label: "Bíceps", labelKey: "categories.biceps", color: "#D4537E" },
    { key: "triceps", label: "Tríceps", labelKey: "categories.triceps", color: "#7F77DD" },
    { key: "core", label: "Core", labelKey: "categories.core", color: "#1D9E75" },
    { key: "cardio", label: "Cardio", labelKey: "categories.cardio", color: "#D85A30" },
] as const;
