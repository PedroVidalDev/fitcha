...
export const StepResult = (props: StepResultProps) => {
    ...
    const selectedDaysLabel =
        data.selectedDays.length > 0
            ? data.selectedDays
                  .map((dayIndex) => translate(getDayLabelKey(dayIndex)))
                  .join(', ')
            : '-'
    ...
    const summaryItems = [
        ...
        {
            label: translate('aiWizard.review.selectedDays'),
            value: selectedDaysLabel,
        },
        {
            label: translate('aiWizard.review.totalDays'),
            value: String(data.selectedDays.length),
        },
        {
            label: translate('aiWizard.review.hoursPerDay'),
            value:
                data.hoursPerDay.trim() ||
                translate('aiWizard.review.notInformed'),
        },
        {
            label: translate('aiWizard.review.machinesPerDay'),
            value:
                data.machinesPerDay.trim() ||
                translate('aiWizard.review.notInformed'),
        },
        {
            label: translate('aiWizard.review.split'),
            value:
                data.workoutSplit.trim() ||
                translate('aiWizard.review.noSpecificSplit'),
        },
        {
        ...
        },
        {
            ...
            value:
                ...
                translate('aiWizard.review.noAdditionalNotes'),
        },
    ]
