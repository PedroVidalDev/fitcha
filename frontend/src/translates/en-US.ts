...
export const enUS: TranslationDictionary = {
    ...
    "detail.record.subtitle": "Sequence with the highest saved volume for this machine.",
    ...
    "detail.history.empty": "No records yet. Start a workout to log weights and reps.",
